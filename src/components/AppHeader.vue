...
<template>
  <header>
    <div
      class="nav-bar container d-flex justify-content-between align-items-center"
    >
      <div class="logo">
    ...
    <div class="jumbotron text-white py-4">
      <h1>MAKE A DIFFERENCE</h1>
      <p class="py-3">
        As a long as a poverty, injustice & inequality persist, none of uscan
        truly rest
      </p>
      <div>
